            ...
            <div id="role_panel" class="w-100 h-100">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-4 col-sm-12">
                        <button data-role="5" style="font-size: 18px ;" class="btn btn-primary btn-block mt-md-2 role">
                    ...
                    <div class="col-12 col-md-4 col-sm-12">
                        <button data-role="4" style="font-size: 18px ;" class="btn btn-primary btn-block mt-md-2 role">
