        ...
        <div class="col-12 mt-5">
            <form class="row" method="POST" action="{{ route('login') }}">
                ...
                <div class="col-12 offset-md-4 col-md-4 d-flex justify-content-around">
                    <button class="btn text-white" style="height: 50px ;background: #3b5998 ;">
                    ...
                    <button class="btn text-white" style="height: 50px ;background: #A3AAAE;">
                    ...
                    <button class="btn text-white" style="height: 50px ;background: #db4a39 ;">
