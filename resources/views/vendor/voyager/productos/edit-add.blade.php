...
@section('javascript')
    <script>
        ...
        $('document').ready(function () {
            ...
            console.log("categorias = ",categoria_productos);
            for( j = 0 ; j < categoria_productos.length ; j++ ){
                console.log("categorias = ",categoria_productos[j]);
                if( $(`#categoria${categoria_productos[j].id}`).checked ){
                    console.log(true)
                } else {
                    $(`#categoria${categoria_productos[j].id}`).prop("checked", true);
                    for( i = 0 ; i < categorias.length ; i++ ){
                        
                        if(categorias[i].categoria_id == categoria_productos[j].id ){
                            console.log("aquiii",`#lista-categoria${categoria_productos[j].id}`)
                            $(`#lista-categoria${categoria_productos[j].id}`).append(`
                            <li style="list-style:none;" data-parent="null" >
                                <div class="form-check">
                                    <input name="categorias[]" value="${categorias[i].id}" onChange="checkCategoria(this)" type="checkbox" class="form-check-input check-categoria" data-id="${categorias[i].id}" id="categoria${categorias[i].id}">
                                    <label class="form-check-label" for="categoria${categorias[i].id}">${categorias[i].categoria}</label>
